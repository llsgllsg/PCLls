...
try:
    ...
    if response.status_code == 200:
        ...
        if not os.path.exists(file_path):
            ...
            # 建立 expected 新内容字符串
            new_content = f'<local:MyCard Title="事件：{title}，类型：{type_event}" Margin="300,0,0,15" CanSwap="False" IsSwaped="True">\n' \
